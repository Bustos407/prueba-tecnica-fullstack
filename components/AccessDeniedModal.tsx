...
export const AccessDeniedModal = ({ isOpen, onClose, feature }: AccessDeniedModalProps) => {
        ...
        <div className="mb-6">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-md p-3">
            <p className="text-sm text-yellow-800">
              <strong>Requisito:</strong> Esta función está disponible solo para usuarios con rol de Administrador.
            </p>
          </div>
        </div>
