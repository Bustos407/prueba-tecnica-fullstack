...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  // Servir la página de Swagger UI como HTML
  const html = `
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    ...
    info: {
      ...
      version: '1.0.0',
                    description: 'API para el sistema de gestión de ingresos y egresos con autenticación por cookies',
                    contact: {
                      name: 'Soporte API',
    ...
    components: {
      securitySchemes: {
                      cookieAuth: {
                        ...
                        in: 'cookie',
                        name: 'session',
                        description: 'Cookie de sesión para autenticación. Se maneja automáticamente por el navegador.',
                      },
                    },
                    schemas: {
                      Transaction: {
                      ...
                      UserInput: {
                        ...
                        properties: {
                          name: { type: 'string', description: 'Nombre del usuario' },
                          email: { type: 'string', description: 'Email del usuario' },
                          role: { type: 'string', enum: ['USER', 'ADMIN'], description: 'Rol del usuario', default: 'USER' }
                        }
                      }
                    }
                  },
                    ...
                    '/api/transactions': {
                      ...
                      post: {
                        ...
                        responses: {
                            ...
                            content: {
                              'application/json': {
                                schema: {
                                  type: 'object',
                                  properties: {
                                    error: { type: 'string', example: 'Todos los campos son requeridos' }
                                  }
                                }
                              }
                            }
                          ...
                          '401': { description: 'No autenticado' },
                          '403': { description: 'Acceso denegado. Solo los administradores pueden crear transacciones' },
                          '500': { description: 'Error interno del servidor' }
                        }
                      }
                    },
                    '/api/transactions/{id}': {
                      put: {
                        ...
                        responses: {
                          ...
                          '401': { description: 'No autenticado' },
                          '403': { description: 'Acceso denegado. Solo los administradores pueden actualizar transacciones' },
                      ...
                      delete: {
                        ...
                        responses: {
                          ...
                          '401': { description: 'No autenticado' },
                          '403': { description: 'Acceso denegado. Solo los administradores pueden eliminar transacciones' },
                          '404': { description: 'Transacción no encontrada' },
                          '500': { description: 'Error interno del servidor' }
                        }
                      }
                    ...
                    '/api/users': {
                      get: {
                        ...
                        responses: {
                          ...
                          '401': { description: 'No autenticado' },
                          '403': { description: 'Acceso denegado. Solo los administradores pueden ver usuarios' },
                          '500': { description: 'Error interno del servidor' }
                        }
                      },
                      post: {
                        ...
                        responses: {
                          ...
                          '401': { description: 'No autenticado' },
                          '403': { description: 'Acceso denegado. Solo los administradores pueden crear usuarios' },
                          '500': { description: 'Error interno del servidor' }
                        }
                      },
                      delete: {
                        ...
                        responses: {
                          ...
                          '401': { description: 'No autenticado' },
                          '403': { description: 'Acceso denegado o intento de eliminar usuario de pruebas' },
                    ...
                    '/api/users/{id}': {
                      put: {
                        ...
                        responses: {
                          ...
                          '400': { description: 'Datos inválidos o email ya registrado' },
                          '401': { description: 'No autenticado' },
                          '403': { description: 'Acceso denegado. Solo los administradores pueden actualizar usuarios' },
                          '404': { description: 'Usuario no encontrado' },
                          '500': { description: 'Error interno del servidor' }
                        }
                      }
                          ...
                          '200': {
                            ...
                            headers: {
                              'Content-Disposition': {
                                ...
                                schema: { type: 'string', example: 'attachment; filename="reporte-transacciones.csv"' }
                              }
                            }
                          },
                          '401': { description: 'No autenticado' },
                          '403': { description: 'Acceso denegado. Solo los administradores pueden descargar reportes' },
                          '500': { description: 'Error interno del servidor' }
                        }
                      }
                    }
